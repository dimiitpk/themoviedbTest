...
class TvCastListAdapter(
    ...
    val DIFF_CALLBACK = object : DiffUtil.ItemCallback<TVCast>() {
    ...
    fun submitList(list: List<TVCast>?) {
    ...
    constructor(
        ...
        fun bind(item: TVCast) = with(itemView) {
    ...
    interface Interaction {
        fun onItemSelected(position: Int, item: TVCast)
    }
}